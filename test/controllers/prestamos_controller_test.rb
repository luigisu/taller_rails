...
class PrestamosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestamo" do
    assert_difference('Prestamo.count') do
      post prestamos_url, params: { prestamo: { estado: @prestamo.estado, fecha: @prestamo.fecha, references: @prestamo.references, usuarios: @prestamo.usuarios } }
    end
  ...
  test "should update prestamo" do
    patch prestamo_url(@prestamo), params: { prestamo: { estado: @prestamo.estado, fecha: @prestamo.fecha, references: @prestamo.references, usuarios: @prestamo.usuarios } }
