...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { cantida: @detalle.cantida, libros_id: @detalle.libros_id, prestamos_id: @detalle.prestamos_id } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { cantida: @detalle.cantida, libros_id: @detalle.libros_id, prestamos_id: @detalle.prestamos_id } }
