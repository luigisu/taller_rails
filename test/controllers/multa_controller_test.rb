...
class MultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multum" do
    assert_difference('Multum.count') do
      post multa_url, params: { multum: { decimal: @multum.decimal, estado: @multum.estado, fecha: @multum.fecha, prestamos_id: @multum.prestamos_id, valor: @multum.valor } }
    end
  ...
  test "should update multum" do
    patch multum_url(@multum), params: { multum: { decimal: @multum.decimal, estado: @multum.estado, fecha: @multum.fecha, prestamos_id: @multum.prestamos_id, valor: @multum.valor } }
